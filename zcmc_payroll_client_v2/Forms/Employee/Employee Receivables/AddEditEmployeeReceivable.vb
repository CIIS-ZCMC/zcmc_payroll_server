Public Class AddEditEmployeeReceivable
    Dim helper As New Helpers

    Private service As New EmployeeReceivableService
    Private serviceReceivable As New ReceivableService
    ...
    Public _employeeReceivableID As String
    Public _payroll_period_id As Integer
    Public _employeeID As Integer
    Public _receivableID As Integer
    Public _receivableCode As String
    ...
    Private Async Sub btnNext_Click(sender As Object, e As EventArgs) Handles btnNext.Click
        Dim dto As EmployeeReceivableDto
        ...
        ElseIf edit = True Then
            result = Await service.Update(_employeeReceivableID, dto, "toUpdate")
        End If
    ...
    Private Async Sub AddEditEmployeeReceivable_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If edit = True Then
            ...
            _employeeReceivableID = row.Cells(1).Value
            _payroll_period_id = row.Cells(2).Value
            _employeeID = row.Cells(3).Value
            _receivableID = row.Cells(4).Value
            ...
            '' Match the loaded _receivableID to cmbReceivable
            For Each item As Object In cmbReceivable.Items
                Dim receivableItem As ComboItem = TryCast(item, ComboItem)
                If receivableItem IsNot Nothing AndAlso receivableItem.Id = _receivableID Then
                    cmbReceivable.SelectedItem = receivableItem
                    Exit For
                End If
            Next
    ...
    Private Function ValidateAndBuild() As EmployeeReceivableDto

        If cmbReceivable.SelectedValue Is Nothing Then
            Throw New Exception("Please select a receivable.")
        End If
