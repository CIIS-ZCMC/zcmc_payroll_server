Public Class EmployeeApi
    Public Shared Async Function GetAll(Optional type As String = "", Optional perPage As Integer = 15, Optional page As Integer = 1) As Task(Of ApiResponse(Of List(Of EmployeeResponse)))
        Dim endpoint As String = $"{urlEmployee}?type={type}&per_page={perPage}&page={page}"
