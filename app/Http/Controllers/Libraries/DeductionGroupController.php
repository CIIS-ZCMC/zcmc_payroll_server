...
use App\Http\Requests\StoreDeductionGroupRequest;
use App\Http\Requests\UpdateDeductionGroupRequest;
...
class DeductionGroupController extends Controller
{
    ...
    public function store(StoreDeductionGroupRequest $request)
    {
    ...
    public function update(int $id, UpdateDeductionGroupRequest $request)
    {
        $dto = DeductionGroupData::fromRequest($request);
