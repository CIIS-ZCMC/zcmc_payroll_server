...
namespace App\Filament\Resources\EmployeeReceivables\Tables;
...
class EmployeeReceivablesTable
{
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('receivable.name')
                    ->label('Receivable')
                    ->searchable(),
                TextColumn::make('receivable.code')
                    ->label('Code')
                    ->toggleable(),
            ...
            ->filters([
                ...
                SelectFilter::make('receivable_id')
                    ->label('Receivable')
