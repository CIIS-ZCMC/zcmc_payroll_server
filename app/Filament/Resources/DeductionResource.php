...
class DeductionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('deduction_group_id')
                    ->required(),
                Forms\Components\TextInput::make('deduction_uuid')
                    ->required()
                    ->maxLength(36),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('deduction_group_id'),
                Tables\Columns\TextColumn::make('deduction_uuid'),
